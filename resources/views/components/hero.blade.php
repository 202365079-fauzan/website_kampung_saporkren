...
<section class="hero" style="padding: 0; min-height: 100vh; display: flex; align-items: center; justify-content: center; position: relative;">
    <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 0; overflow: hidden;">
        <video style="width: 100%; height: 100%; object-fit: cover; background: black;" autoplay loop muted playsinline preload="auto" disablepictureinpicture controlslist="nodownload nofullscreen noremoteplayback" src="{{ asset('assets/video-kampung.mp4') }}"></video>
    ...
    <div class="container" style="position: relative; z-index: 10;">
        <div class="hero-content" style="padding-top: 5rem; text-align: center;">
            ...
            <h1 style="color: white; margin-bottom: 1.5rem; line-height: 1.15; ">
            ...
            <div class ="hero-location" style="margin-top: 3rem; display: inline-flex; align-items: center; gap: 0.6rem; border: 1px solid rgba(255,255,255,0.25); background: rgba(255,255,255,0.12); padding: 0.5rem 1.25rem; border-radius: 9999px; color: white;  font-weight: 500; backdrop-filter: blur(8px);">
